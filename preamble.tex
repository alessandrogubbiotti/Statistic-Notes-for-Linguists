...
\usepackage{graphicx}
\usepackage{float}  % [H] placement for figures inside tcolorbox

\graphicspath{
  {images/}
  {../images/}
  {images/events/}
  {images/measurable_spaces/}
}

\input{build/knitr_header}
\IfFileExists{upquote.sty}{\usepackage{upquote}}{}  % straight quotes in code, as knitr does
...
\newtheorem{longexample}[example]{Example}

\theoremstyle{definition}
\newtheorem{model}{Model}[chapter]
...
\newif\ifsolutions
\solutionstrue          % comment this line out to hide the solutions

\ifsolutions
  \usepackage{exercise}   % or just \usepackage{exercise} for answers in place
\else
